...
@mock.patch('iib.workers.tasks.build_containerized_rm._skopeo_copy')
@mock.patch('iib.workers.tasks.build_containerized_rm.get_worker_config')
@mock.patch('iib.workers.tasks.build_containerized_rm.push_oras_artifact')
@mock.patch('iib.workers.tasks.build_containerized_rm.get_image_digest')
@mock.patch('iib.workers.tasks.build_containerized_rm.get_indexdb_artifact_pullspec')
@mock.patch('iib.workers.tasks.build_containerized_rm._get_artifact_combined_tag')
@mock.patch('iib.workers.tasks.build_containerized_rm._get_name_and_tag_from_pullspec')
@mock.patch('iib.workers.tasks.build_containerized_rm.get_pipelinerun_image_url')
@mock.patch('iib.workers.tasks.build_containerized_rm.wait_for_pipeline_completion')
@mock.patch('iib.workers.tasks.build_containerized_rm.find_pipelinerun')
@mock.patch('iib.workers.tasks.build_containerized_rm.get_last_commit_sha')
@mock.patch('iib.workers.tasks.build_containerized_rm.commit_and_push')
...
@mock.patch('iib.workers.tasks.build_containerized_rm.pull_index_db_artifact')
@mock.patch('iib.workers.tasks.build_containerized_rm.remove_operator_deprecations')
@mock.patch('iib.workers.tasks.build_containerized_rm.clone_git_repo')
@mock.patch('iib.workers.tasks.build_containerized_rm.get_git_token')
...
@mock.patch('iib.workers.tasks.build_containerized_rm.find_pipelinerun')
@mock.patch('iib.workers.tasks.build_containerized_rm.get_last_commit_sha')
@mock.patch('iib.workers.tasks.build_containerized_rm.close_mr')
@mock.patch('iib.workers.tasks.build_containerized_rm.create_mr')
@mock.patch('iib.workers.tasks.build_containerized_rm.write_build_metadata')
@mock.patch('iib.workers.tasks.build_containerized_rm.opm_validate')
@mock.patch('iib.workers.tasks.build_containerized_rm.merge_catalogs_dirs')
@mock.patch('iib.workers.tasks.build_containerized_rm.opm_registry_rm_fbc')
...
def test_handle_containerized_rm_request_with_mr(
    ...
    assert 'Remove operators' in mock_cmr.call_args[1]['commit_message']
...
def test_handle_containerized_rm_with_index_db_push(
    ...
    assert first_push_call[1]['annotations']['operation'] == 'remove_operators'
